function strDir_ImgWarp = Cluster_Scripts_Reg_Linear_2p_par(stPaths_G, strDir_ImgSeq, strImgFn_prefix, idx_S,idx_E, idx_Ref, bClusterOE)
% Generate job shell script for linear image registration and submit the job to
% the computer cluster. The function is compatable with parallel computing toolbox (parfor)
%
%   Inputs:
...
strImgFn_Ref_Sav = [fileparts(fileparts(strDir_ImgSeq)) filesep strImgFn_prefix '_Ref.tif'];
copyfile(strImgFn_Ref,strImgFn_Ref_Sav,'f');
